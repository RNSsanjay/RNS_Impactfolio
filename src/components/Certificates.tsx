...
const Certificate = () => {
  return (
    ...
    >
      ...
      {/* Title */}
      <h2 className="text-3xl md:text-4xl font-extrabold text-center text-green-300 mb-12 relative z-10">
        My Certificates
      </h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 px-6 relative z-10">
        {profileData.certificates.map((certificate) => (
          ...
          >
            {/* Certificate Name */}
            <motion.h3
              className="text-xl md:text-2xl font-semibold text-green-300 mb-4 cursor-pointer"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
